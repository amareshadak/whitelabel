...
{  
    public class HoldBookingConfirmResponsesDTO
    {
        public HoldBookingConfirmResponses HoldBookingConfirmResponses { get; set; }
    }
    // Root myDeserializedClass = JsonConvert.DeserializeObject<Root>(myJsonResponse); 
    public class HoldBookingTicketDetail
    {
    ...
    public class HoldBookingFlightFareDetail
    {
    ...
    public class HoldBookingDetail2
    {
        public string SeqNo { get; set; }
    ...
    public class HoldBookingDetail
    {
        public List<HoldBookingDetail2> Detail { get; set; }
    }

    public class HoldBookingPassengerDetail
    {
        public string SeqNo { get; set; }
        ...
        public List<HoldBookingDetail> Details { get; set; }
    }

    public class HoldBookingConfirmResponse
    {
        public List<HoldBookingTicketDetail> TicketDetails { get; set; }
        public List<HoldBookingFlightFareDetail> FlightFareDetails { get; set; }
        public List<HoldBookingPassengerDetail> PassengerDetails { get; set; }
    }

    public class HoldBookingConfirmResponses
    {
        public List<HoldBookingConfirmResponse> HoldBookingConfirmResponse { get; set; }
    }
