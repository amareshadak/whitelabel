...
namespace WHITELABEL.Web.Areas.Merchant.Controllers
{
    ...
    public class MerchantRequisitionReportController : MerchantBaseController
    {
        ...
        public PartialViewResult IndexGrid(string search = "", string DateFrom = "", string Date_To = "")
        {
            ...
            //if (search == "")
            //{
                var transactionlistvalue = MerchantRequisitionReportViewModel.GetMerchantAllRequisitionReport(CurrentMerchant.MEM_ID.ToString(),search, DateFrom, Date_To);
        ...
        [HttpGet]
        public FileResult ExportMerchantReqIndex(string statusval, string DateFrom, string Date_To)
        {
            ...
            using (ExcelPackage package = new ExcelPackage())
            {
                ...
                IGrid<TBL_BALANCE_TRANSFER_LOGS> grid = CreateExportMerchantReqGrid(statusval, DateFrom, Date_To);
