...
namespace WHITELABEL.Web.Areas.Admin.Controllers
{
    ...
    public class MemberRDSReportsController : AdminBaseController
    {
        ...
        public PartialViewResult IndexGrid(string Whitelevel = "", string Distributor = "", string Merchant = "", string DateFrom = "", string Date_To = "")
        {
            try
            {
                var dbcontext = new DBContext();
                //if (Merchant != "")
                if (Merchant != "" && DateFrom != "" && Date_To != "")
                {
                    long MerId = 0;
                    long.TryParse(Merchant, out MerId);
                    ...
                    var RDSbookinglist = (from x in dbcontext.TBL_FINAL_RDS_BOOKING
                                          ...
                                          where x.DIST_ID == DistId && x.MER_ID == MerId && x.TRAN_DATE >= Date_From_Val && x.TRAN_DATE <= Date_To_Val
                                          select new
                                          {
                                              SLN = x.SLN,
                ...
                else if (Merchant == "" && DateFrom != "" && Date_To != "")
                {
                    long MerId = 0;
                    long.TryParse(Merchant, out MerId);
                    string FromDATE = string.Empty;
        ...
        public PartialViewResult RDSRefundReportGrid(string Whitelevel = "", string Distributor = "", string Merchant = "", string DateFrom = "", string Date_To = "")
        {
            try
            {
                ...
                if (Merchant != "" && DateFrom != "" && Date_To != "")
                {
                    ...
                    var RDSbookinglist = (from x in dbcontext.TBL_FINAL_RDS_BOOKING
                                          join y in dbcontext.TBL_MASTER_MEMBER on x.MER_ID equals y.MEM_ID
                                          where x.DIST_ID == DistId && x.MER_ID == MerId && x.TRAN_DATE >= Date_From_Val && x.TRAN_DATE <= Date_To_Val && x.TRAN_STATUS == "Failed"
                                          select new
                                          {
                                              SLN = x.SLN,
                                              BOOKING_GATEWAY = x.BOOKING_GATEWAY,
                ...
                else
                {
                    var RDSbookinglist = (from x in dbcontext.TBL_FINAL_RDS_BOOKING
                                          join y in dbcontext.TBL_MASTER_MEMBER on x.MER_ID equals y.MEM_ID
                                          where y.MEMBER_ROLE == 3 && x.TRAN_STATUS == "Failed"
                                          select new
                                          {
                                              SLN = x.SLN,
                                              BOOKING_GATEWAY = x.BOOKING_GATEWAY,
        ...
        private IGrid<TBL_FINAL_RDS_BOOKING> RDSRefundReportExportableGrid()
        {
            var dbcontext = new DBContext();
            var memberinfo = (from x in dbcontext.TBL_FINAL_RDS_BOOKING
                              join y in dbcontext.TBL_MASTER_MEMBER on x.MER_ID equals y.MEM_ID
                              where x.TRAN_STATUS == "Failed"
                              select new
                              {
                                  SLN = x.SLN,
                                  BOOKING_GATEWAY = x.BOOKING_GATEWAY,
        ...
        [HttpGet]
        public FileResult ExportRDSRefundReport()
        {
            // Using EPPlus from nuget
            using (ExcelPackage package = new ExcelPackage())
            {
                ...
                package.Workbook.Worksheets.Add("Data");
                IGrid<TBL_FINAL_RDS_BOOKING> grid = RDSRefundReportExportableGrid();
                ExcelWorksheet sheet = package.Workbook.Worksheets["Data"];
        ...
        public PartialViewResult RDSMisMatchRDSIDReportGrid(string DateFrom = "", string Date_To = "")
        {
            try
            {
                var dbcontext = new DBContext();
        ...
        [HttpGet]
        public FileResult ExportRDSMisMatchRDSIdReport(string DateFrom, string Date_To)
        {
            // Using EPPlus from nuget
            using (ExcelPackage package = new ExcelPackage())
            {
                ...
                package.Workbook.Worksheets.Add("Data");
                IGrid<TBL_FINAL_RDS_BOOKING> grid = CreateExportdRDSMisMatchRDSIdReportGrid(DateFrom, Date_To);
                ExcelWorksheet sheet = package.Workbook.Worksheets["Data"];
        ...
        private IGrid<TBL_FINAL_RDS_BOOKING> CreateExportdRDSMisMatchRDSIdReportGrid(string DateFrom, string Date_To)
        {
            var dbcontext = new DBContext();
            //if (Merchant != "")
            if (DateFrom != "" && Date_To != "")
