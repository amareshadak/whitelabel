$(document).ready(function () {
    ...
    $("#txtCreditMemberaName").autocomplete({
        source: function (request, response) {
            
            $.ajax({
                url: '/Admin/MemberCreditManagment/GetCreditSettleMemberName/',
    ...
    $("#txtCreditDebitmemberName").autocomplete({
        source: function (request, response) {
        ...
        focus: function (event, ui) {
            $('#txtCreditDebitmemberName').val(ui.item.label);
            return true;
        },
        select: function (e, i) {
            $("#hdfCreditDebitmemberName").val(i.item.val);
            return true;
        },
        minLength: 1
    });
