var app = angular.module('AirportAutocompleteoduleApp', ['angucomplete-alt', 'angular-loading-bar', 'angular.filter', 'checklist-model', 'infinite-scroll']).config(['cfpLoadingBarProvider', function (cfpLoadingBarProvider) {
